...
typedef struct {
    void* bus_user;
    icm20948_err_t (*bus_init)(void*);
    icm20948_err_t (*bus_deinit)(void*);
    icm20948_err_t (*bus_write)(void*, uint8_t, uint8_t const*, size_t);
    icm20948_err_t (*bus_read)(void*, uint8_t, uint8_t*, size_t);
