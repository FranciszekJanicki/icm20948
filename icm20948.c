...
static icm20948_err_t icm20948_bus_deinitialize(icm20948_t const* icm20948)
{
    return icm20948->interface.bus_deinitialize
               ? icm20948->interface.bus_deinitialize(icm20948->interface.bus_user)
               : ICM20948_ERR_NULL;
}
                                             ...
                                             icm20948_bank_sel_reg_t* reg)
{
    ...
    icm20948_err_t err =
        icm20948_bus_write_data(icm20948, ICM20948_REG_ADDRESS_BANK_SEL, &data, sizeof(data));
                                             ...
                                             icm20948_bank_sel_reg_t const* reg)
{
    ...
    return icm20948_bus_write_data(icm20948, ICM20948_REG_ADDRESS_BANK_SEL, &data, sizeof(data));
}
