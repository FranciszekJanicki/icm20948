...
static icm20948_err_t icm20948_bus_init(icm20948_t const* icm20948)
{
    return icm20948->interface.bus_init ? icm20948->interface.bus_init(icm20948->interface.bus_user)
                                        : ICM20948_ERR_NULL;
}

static icm20948_err_t icm20948_bus_deinit(icm20948_t const* icm20948)
{
    return icm20948->interface.bus_deinit
               ? icm20948->interface.bus_deinit(icm20948->interface.bus_user)
               : ICM20948_ERR_NULL;
}

static icm20948_err_t icm20948_bus_write(icm20948_t const* icm20948,
                                         uint8_t address,
                                         uint8_t const* data,
                                         size_t data_size)
{
    return icm20948->interface.bus_write
               ? icm20948->interface.bus_write(icm20948->interface.bus_user,
                                               address,
                                               data,
                                               data_size)
               : ICM20948_ERR_NULL;
...
static icm20948_err_t icm20948_bus_read(icm20948_t const* icm20948,
                                        uint8_t address,
                                        uint8_t* data,
                                        size_t data_size)
{
    return icm20948->interface.bus_read ? icm20948->interface.bus_read(icm20948->interface.bus_user,
                                                                       address,
                                                                       data,
                                                                       data_size)
                                        : ICM20948_ERR_NULL;
                                          ...
                                          size_t data_size)
{
    ...
    err |= icm20948_bus_write(icm20948, address, data, data_size);
...
{
    icm20948_err_t err = icm20948_bank_select(icm20948, bank);
    err |= icm20948_bus_read(icm20948, address, data, data_size);
                                   ...
                                   icm20948_interface_t const* interface)
{
    ...
    return icm20948_bus_init(icm20948);
}
...
icm20948_err_t icm20948_deinitialize(icm20948_t* icm20948)
{
    ...
    icm20948_err_t err = icm20948_bus_deinit(icm20948);
...
icm20948_err_t icm20948_get_accel_data_x_scaled(icm20948_t const* icm20948, float32_t* scaled)
{
...
icm20948_err_t icm20948_get_accel_data_y_scaled(icm20948_t const* icm20948, float32_t* scaled)
{
    assert(icm20948 && scaled);
...
icm20948_err_t icm20948_get_accel_data_z_scaled(icm20948_t const* icm20948, float32_t* scaled)
{
    assert(icm20948 && scaled);
...
icm20948_err_t icm20948_get_accel_data_scaled(icm20948_t const* icm20948, vec3_float32_t* scaled)
{
    assert(icm20948 && scaled);
...
icm20948_err_t icm20948_get_accel_data_x_raw(icm20948_t const* icm20948, int16_t* raw)
{
    assert(icm20948 && raw);
...
icm20948_err_t icm20948_get_accel_data_y_raw(icm20948_t const* icm20948, int16_t* raw)
{
    assert(icm20948 && raw);
...
icm20948_err_t icm20948_get_accel_data_z_raw(icm20948_t const* icm20948, int16_t* raw)
{
    assert(icm20948 && raw);
...
icm20948_err_t icm20948_get_accel_data_raw(icm20948_t const* icm20948, vec3_int16_t* raw)
{
    assert(icm20948 && raw);
...
icm20948_err_t icm20948_get_gyro_data_x_scaled(icm20948_t const* icm20948, float32_t* scaled)
{
    assert(icm20948 && scaled);
...
icm20948_err_t icm20948_get_gyro_data_y_scaled(icm20948_t const* icm20948, float32_t* scaled)
{
    assert(icm20948 && scaled);
...
icm20948_err_t icm20948_get_gyro_data_z_scaled(icm20948_t const* icm20948, float32_t* scaled)
{
    assert(icm20948 && scaled);
...
icm20948_err_t icm20948_get_gyro_data_scaled(icm20948_t const* icm20948, vec3_float32_t* scaled)
{
    assert(icm20948 && scaled);
...
icm20948_err_t icm20948_get_gyro_data_x_raw(icm20948_t const* icm20948, int16_t* raw)
{
    assert(icm20948 && raw);
...
icm20948_err_t icm20948_get_gyro_data_y_raw(icm20948_t const* icm20948, int16_t* raw)
{
    assert(icm20948 && raw);
...
icm20948_err_t icm20948_get_gyro_data_z_raw(icm20948_t const* icm20948, int16_t* raw)
{
    assert(icm20948 && raw);
...
icm20948_err_t icm20948_get_gyro_data_raw(icm20948_t const* icm20948, vec3_int16_t* raw)
{
    assert(icm20948 && raw);
...
icm20948_err_t icm20948_get_temp_data_scaled(icm20948_t const* icm20948, float32_t* scaled)
{
    assert(icm20948 && scaled);
...
icm20948_err_t icm20948_get_temp_data_raw(icm20948_t const* icm20948, int16_t* raw)
{
    assert(icm20948 && raw);
                                     ...
                                     uint8_t data_size)
{
    ...
    icm20948_err_t err = icm20948_get_i2c_slv_addr_reg(icm20948, slave_num, &slv_addr_reg);
    ...
    err |= icm20948_bank_read(icm20948,
                              ICM20948_BANK_0,
                              ICM20948_REG_ADDRESS_EXT_SLV_SENS_DATA_00,
                              data,
                              data_size);
                                      ...
                                      uint8_t data_size)
{
    ...
    err |= icm20948_bank_write(icm20948, ICM20948_BANK_0, slave_num, data, data_size);

    return err;
}

icm20948_err_t icm20948_fifo_read(icm20948_t const* icm20948, uint8_t* data, uint8_t data_size)
{
    assert(icm20948 && data);

    return icm20948_bank_read(icm20948,
                              ICM20948_BANK_0,
                              ICM20948_REG_ADDRESS_FIFO_R_W,
                              data,
                              data_size);
}
                                   ...
                                   uint8_t data_size)
{
    ...
    return icm20948_bank_write(icm20948,
                               ICM20948_BANK_0,
                               ICM20948_REG_ADDRESS_FIFO_R_W,
                               data,
                               data_size);
...
icm20948_err_t icm20948_bank_select(icm20948_t const* icm20948, icm20948_bank_t bank)
{
    assert(icm20948);
                                             ...
                                             icm20948_bank_sel_reg_t* reg)
{
    ...
    icm20948_err_t err =
        icm20948_bus_write(icm20948, ICM20948_REG_ADDRESS_BANK_SEL, &data, sizeof(data));
...
icm20948_err_t icm20948_set_reg_bank_sel_reg(icm20948_t const* icm20948,
                                             icm20948_bank_sel_reg_t const* reg)
{
    ...
    return icm20948_bus_write(icm20948, ICM20948_REG_ADDRESS_BANK_SEL, &data, sizeof(data));
}

icm20948_err_t icm20948_get_who_am_i_reg(icm20948_t const* icm20948, icm20948_who_am_i_reg_t* reg)
{
    assert(icm20948 && reg);

    uint8_t data = {};

    icm20948_err_t err = icm20948_bank_read(icm20948,
                                            ICM20948_BANK_0,
                                            ICM20948_REG_ADDRESS_WHO_AM_I,
                                            &data,
                                            sizeof(data));
...
icm20948_err_t icm20948_get_user_ctrl_reg(icm20948_t const* icm20948, icm20948_user_ctrl_reg_t* reg)
{
    assert(icm20948 && reg);
    ...
    icm20948_err_t err = icm20948_bank_read(icm20948,
                                            ICM20948_BANK_0,
                                            ICM20948_REG_ADDRESS_USER_CTRL,
                                            &data,
                                            sizeof(data));
                                          ...
                                          icm20948_user_ctrl_reg_t const* reg)
{
    ...
    data &= ~((0x01U << 7U) | (0x01U << 6U) | (0x01U << 5U) | (0x01U << 4U) | (0x01U << 3U) |
              (0x01U << 2U) | (0x01U << 1U));
    ...
    err |= icm20948_bank_write(icm20948,
                               ICM20948_BANK_0,
                               ICM20948_REG_ADDRESS_USER_CTRL,
                               &data,
                               sizeof(data));
...
icm20948_err_t icm20948_get_lp_config_reg(icm20948_t const* icm20948, icm20948_lp_config_reg_t* reg)
{
    assert(icm20948 && reg);
    ...
    icm20948_err_t err = icm20948_bank_read(icm20948,
                                            ICM20948_BANK_0,
                                            ICM20948_REG_ADDRESS_LP_CONFIG,
                                            &data,
                                            sizeof(data));
                                           ...
                                           icm20948_pwr_mgmt_1_reg_t* reg)
{
    ...
    icm20948_err_t err = icm20948_bank_read(icm20948,
                                            ICM20948_BANK_0,
                                            ICM20948_REG_ADDRESS_PWR_MGMT_1,
                                            &data,
                                            sizeof(data));
...
icm20948_err_t icm20948_set_pwr_mgmt_1_reg(icm20948_t const* icm20948,
                                           icm20948_pwr_mgmt_1_reg_t const* reg)
{
    ...
    data &= ~((0x01U << 7U) | (0x01U << 6U) | (0x01U << 5U) | (0x01U << 3U) | 0x07U);
                                           ...
                                           icm20948_pwr_mgmt_2_reg_t* reg)
{
    ...
    icm20948_err_t err = icm20948_bank_read(icm20948,
                                            ICM20948_BANK_0,
                                            ICM20948_REG_ADDRESS_PWR_MGMT_2,
                                            &data,
                                            sizeof(data));
...
icm20948_err_t icm20948_set_pwr_mgmt_2_reg(icm20948_t const* icm20948,
                                            ...
                                            icm20948_int_pin_cfg_reg_t* reg)
{
    ...
    icm20948_err_t err = icm20948_bank_read(icm20948,
                                            ICM20948_BANK_0,
                                            ICM20948_REG_ADDRESS_INT_PIN_CFG,
                                            &data,
                                            sizeof(data));
...
icm20948_err_t icm20948_set_int_pin_cfg_reg(icm20948_t const* icm20948,
                                           ...
                                           icm20948_int_enable_reg_t* reg)
{
    ...
    icm20948_err_t err = icm20948_bank_read(icm20948,
                                            ICM20948_BANK_0,
                                            ICM20948_REG_ADDRESS_INT_ENABLE,
                                            &data,
                                            sizeof(data));
...
icm20948_err_t icm20948_set_int_enable_reg(icm20948_t const* icm20948,
...
icm20948_err_t icm20948_set_int_enable_1_reg(icm20948_t const* icm20948,
...
icm20948_err_t icm20948_set_int_enable_2_reg(icm20948_t const* icm20948,
...
icm20948_err_t icm20948_set_int_enable_3_reg(icm20948_t const* icm20948,
...
icm20948_err_t icm20948_get_i2c_mst_status_reg(icm20948_t const* icm20948,
                                           ...
                                           icm20948_int_status_reg_t* reg)
{
    ...
    icm20948_err_t err = icm20948_bank_read(icm20948,
                                            ICM20948_BANK_0,
                                            ICM20948_REG_ADDRESS_INT_STATUS,
                                            &data,
                                            sizeof(data));
                                           ...
                                           icm20948_delay_time_reg_t* reg)
{
    ...
    icm20948_err_t err = icm20948_bank_read(icm20948,
                                            ICM20948_BANK_0,
                                            ICM20948_REG_ADDRESS_DELAY_TIMEH,
                                            data,
                                            sizeof(data));
                                           ...
                                           icm20948_accel_xout_reg_t* reg)
{
    ...
    icm20948_err_t err = icm20948_bank_read(icm20948,
                                            ICM20948_BANK_0,
                                            ICM20948_REG_ADDRESS_ACCEL_XOUT_H,
                                            data,
                                            sizeof(data));
                                           ...
                                           icm20948_accel_yout_reg_t* reg)
{
    ...
    icm20948_err_t err = icm20948_bank_read(icm20948,
                                            ICM20948_BANK_0,
                                            ICM20948_REG_ADDRESS_ACCEL_YOUT_H,
                                            data,
                                            sizeof(data));
                                           ...
                                           icm20948_accel_zout_reg_t* reg)
{
    ...
    icm20948_err_t err = icm20948_bank_read(icm20948,
                                            ICM20948_BANK_0,
                                            ICM20948_REG_ADDRESS_ACCEL_ZOUT_H,
                                            data,
                                            sizeof(data));
...
icm20948_err_t icm20948_get_accel_out_reg(icm20948_t const* icm20948, icm20948_accel_out_reg_t* reg)
{
    assert(icm20948 && reg);
...
icm20948_err_t icm20948_get_gyro_xout_reg(icm20948_t const* icm20948, icm20948_gyro_xout_reg_t* reg)
{
    assert(icm20948 && reg);
    ...
    icm20948_err_t err = icm20948_bank_read(icm20948,
                                            ICM20948_BANK_0,
                                            ICM20948_REG_ADDRESS_GYRO_XOUT_H,
                                            data,
                                            sizeof(data));
...
icm20948_err_t icm20948_get_gyro_yout_reg(icm20948_t const* icm20948, icm20948_gyro_yout_reg_t* reg)
{
    assert(icm20948 && reg);
    ...
    icm20948_err_t err = icm20948_bank_read(icm20948,
                                            ICM20948_BANK_0,
                                            ICM20948_REG_ADDRESS_GYRO_YOUT_H,
                                            data,
                                            sizeof(data));
...
icm20948_err_t icm20948_get_gyro_zout_reg(icm20948_t const* icm20948, icm20948_gyro_zout_reg_t* reg)
{
    assert(icm20948 && reg);
    ...
    icm20948_err_t err = icm20948_bank_read(icm20948,
                                            ICM20948_BANK_0,
                                            ICM20948_REG_ADDRESS_GYRO_ZOUT_H,
                                            data,
                                            sizeof(data));
...
icm20948_err_t icm20948_get_gyro_out_reg(icm20948_t const* icm20948, icm20948_gyro_out_reg_t* reg)
{
    assert(icm20948 && reg);
...
icm20948_err_t icm20948_get_temp_out_reg(icm20948_t const* icm20948, icm20948_temp_out_reg_t* reg)
{
    assert(icm20948 && reg);
    ...
    icm20948_err_t err = icm20948_bank_read(icm20948,
                                            ICM20948_BANK_0,
                                            ICM20948_REG_ADDRESS_TEMP_OUT_H,
                                            data,
                                            sizeof(data));
...
icm20948_err_t icm20948_get_ext_slv_sens_data_reg(icm20948_t const* icm20948,
                                                  uint8_t reg_num,
                                                  icm20948_ext_slv_sens_data_reg_t* reg)
{
    ...
    icm20948_err_t err =
        icm20948_bank_read(icm20948,
                           ICM20948_BANK_0,
                           ICM20948_REG_ADDRESS_EXT_SLV_SENS_DATA_00 + (reg_num & 0x17U),
                           &data,
                           sizeof(data));
...
icm20948_err_t icm20948_get_fifo_en_1_reg(icm20948_t const* icm20948, icm20948_fifo_en_1_reg_t* reg)
{
    assert(icm20948 && reg);
    ...
    icm20948_err_t err = icm20948_bank_read(icm20948,
                                            ICM20948_BANK_0,
                                            ICM20948_REG_ADDRESS_FIFO_EN_1,
                                            &data,
                                            sizeof(data));
...
icm20948_err_t icm20948_get_fifo_en_2_reg(icm20948_t const* icm20948, icm20948_fifo_en_2_reg_t* reg)
{
    assert(icm20948 && reg);
    ...
    icm20948_err_t err = icm20948_bank_read(icm20948,
                                            ICM20948_BANK_0,
                                            ICM20948_REG_ADDRESS_FIFO_EN_2,
                                            &data,
                                            sizeof(data));
                                          ...
                                          icm20948_fifo_en_2_reg_t const* reg)
{
    ...
    data &= ~((0x01U << 4U) | (0x01U << 3U) | (0x01U << 2U) | (0x01U << 1U) | 0x01U);
...
icm20948_err_t icm20948_get_fifo_rst_reg(icm20948_t const* icm20948, icm20948_fifo_rst_reg_t* reg)
{
    assert(icm20948 && reg);
...
icm20948_err_t icm20948_get_fifo_mode_reg(icm20948_t const* icm20948, icm20948_fifo_mode_reg_t* reg)
{
    assert(icm20948 && reg);
    ...
    icm20948_err_t err = icm20948_bank_read(icm20948,
                                            ICM20948_BANK_0,
                                            ICM20948_REG_ADDRESS_FIFO_MODE,
                                            &data,
                                            sizeof(data));
...
icm20948_err_t icm20948_get_fifo_cnt_reg(icm20948_t const* icm20948, icm20948_fifo_cnt_reg_t* reg)
{
    assert(icm20948 && reg);
    ...
    icm20948_err_t err = icm20948_bank_read(icm20948,
                                            ICM20948_BANK_0,
                                            ICM20948_REG_ADDRESS_FIFO_COUNTH,
                                            data,
                                            sizeof(data));
...
icm20948_err_t icm20948_get_fifo_r_w_reg(icm20948_t const* icm20948, icm20948_fifo_r_w_reg_t* reg)
{
    assert(icm20948 && reg);
...
icm20948_err_t icm20948_get_data_rdy_status(icm20948_t const* icm20948,
...
icm20948_err_t icm20948_get_fifo_cfg_reg(icm20948_t const* icm20948, icm20948_fifo_cfg_reg_t* reg)
{
    assert(icm20948 && reg);
...
icm20948_err_t icm20948_get_self_test_x_gyro_reg(icm20948_t const* icm20948,
...
icm20948_err_t icm20948_set_self_test_x_gyro_reg(icm20948_t const* icm20948,
...
icm20948_err_t icm20948_get_self_test_y_gyro_reg(icm20948_t const* icm20948,
...
icm20948_err_t icm20948_set_self_test_y_gyro_reg(icm20948_t const* icm20948,
...
icm20948_err_t icm20948_get_self_test_z_gyro_reg(icm20948_t const* icm20948,
...
icm20948_err_t icm20948_set_self_test_z_gyro_reg(icm20948_t const* icm20948,
...
icm20948_err_t icm20948_get_self_test_x_accel_reg(icm20948_t const* icm20948,
                                                  icm20948_self_test_x_accel_reg_t* reg)
{
    ...
    icm20948_err_t err = icm20948_bank_read(icm20948,
                                            ICM20948_BANK_1,
                                            ICM20948_REG_ADDRESS_SELF_TEST_X_ACCEL,
                                            &data,
                                            sizeof(data));
...
icm20948_err_t icm20948_set_self_test_x_accel_reg(icm20948_t const* icm20948,
...
icm20948_err_t icm20948_get_self_test_y_accel_reg(icm20948_t const* icm20948,
                                                  icm20948_self_test_y_gyro_reg_t* reg)
{
    assert(icm20948 && reg);
    ...
    icm20948_err_t err = icm20948_bank_read(icm20948,
                                            ICM20948_BANK_1,
                                            ICM20948_REG_ADDRESS_SELF_TEST_Y_ACCEL,
                                            &data,
                                            sizeof(data));
...
icm20948_err_t icm20948_set_self_test_y_accel_reg(icm20948_t const* icm20948,
                                                  icm20948_self_test_y_gyro_reg_t const* reg)
{
    assert(icm20948 && reg);
...
icm20948_err_t icm20948_get_self_test_z_accel_reg(icm20948_t const* icm20948,
                                                  icm20948_self_test_z_gyro_reg_t* reg)
{
    assert(icm20948 && reg);
    ...
    icm20948_err_t err = icm20948_bank_read(icm20948,
                                            ICM20948_BANK_1,
                                            ICM20948_REG_ADDRESS_SELF_TEST_Z_ACCEL,
                                            &data,
                                            sizeof(data));
...
icm20948_err_t icm20948_set_self_test_z_accel_reg(icm20948_t const* icm20948,
                                                  icm20948_self_test_z_gyro_reg_t const* reg)
{
    assert(icm20948 && reg);
...
icm20948_err_t icm20948_get_xa_offs_reg(icm20948_t const* icm20948, icm20948_xa_offs_reg_t* reg)
{
    assert(icm20948 && reg);
    ...
    icm20948_err_t err = icm20948_bank_read(icm20948,
                                            ICM20948_BANK_1,
                                            ICM20948_REG_ADDRESS_XA_OFFS_H,
                                            data,
                                            sizeof(data));
...
icm20948_err_t icm20948_get_ya_offs_reg(icm20948_t const* icm20948, icm20948_ya_offs_reg_t* reg)
{
    assert(icm20948 && reg);
    ...
    icm20948_err_t err = icm20948_bank_read(icm20948,
                                            ICM20948_BANK_1,
                                            ICM20948_REG_ADDRESS_YA_OFFS_H,
                                            data,
                                            sizeof(data));
...
icm20948_err_t icm20948_get_za_offs_reg(icm20948_t const* icm20948, icm20948_za_offs_reg_t* reg)
{
    assert(icm20948 && reg);
    ...
    icm20948_err_t err = icm20948_bank_read(icm20948,
                                            ICM20948_BANK_1,
                                            ICM20948_REG_ADDRESS_ZA_OFFS_H,
                                            data,
                                            sizeof(data));
...
icm20948_err_t icm20948_get_tbc_pll_reg(icm20948_t const* icm20948, icm20948_tbc_pll_reg_t* reg)
{
    assert(icm20948 && reg);
...
icm20948_err_t icm20948_get_gyro_smplrt_div_reg(icm20948_t const* icm20948,
...
icm20948_err_t icm20948_set_gyro_smplrt_div_reg(icm20948_t const* icm20948,
...
icm20948_err_t icm20948_get_gyro_config_1_reg(icm20948_t const* icm20948,
...
icm20948_err_t icm20948_set_gyro_config_1_reg(icm20948_t const* icm20948,
...
icm20948_err_t icm20948_get_gyro_config_2_reg(icm20948_t const* icm20948,
...
icm20948_err_t icm20948_set_gyro_config_2_reg(icm20948_t const* icm20948,
                                            ...
                                            icm20948_xg_offs_usr_reg_t* reg)
{
    ...
    icm20948_err_t err = icm20948_bank_read(icm20948,
                                            ICM20948_BANK_2,
                                            ICM20948_REG_ADDRESS_XG_OFFS_USRH,
                                            data,
                                            sizeof(data));
...
icm20948_err_t icm20948_set_xg_offs_usr_reg(icm20948_t const* icm20948,
                                            ...
                                            icm20948_yg_offs_usr_reg_t* reg)
{
    ...
    icm20948_err_t err = icm20948_bank_read(icm20948,
                                            ICM20948_BANK_2,
                                            ICM20948_REG_ADDRESS_YG_OFFS_USRH,
                                            data,
                                            sizeof(data));
...
icm20948_err_t icm20948_set_yg_offs_usr_reg(icm20948_t const* icm20948,
                                            ...
                                            icm20948_zg_offs_usr_reg_t* reg)
{
    ...
    icm20948_err_t err = icm20948_bank_read(icm20948,
                                            ICM20948_BANK_2,
                                            ICM20948_REG_ADDRESS_ZG_OFFS_USRH,
                                            data,
                                            sizeof(data));
...
icm20948_err_t icm20948_set_zg_offs_usr_reg(icm20948_t const* icm20948,
...
icm20948_err_t icm20948_set_odr_align_en_reg(icm20948_t const* icm20948,
...
icm20948_err_t icm20948_get_accel_smplrt_div_reg(icm20948_t const* icm20948,
                                                 icm20948_accel_smplrt_div_reg_t* reg)
{
    ...
    icm20948_err_t err = icm20948_bank_read(icm20948,
                                            ICM20948_BANK_2,
                                            ICM20948_REG_ADDRESS_ACCEL_SMPLRT_DIV_1,
                                            data,
                                            sizeof(data));

    reg->accel_smplrt_div = (uint16_t)(((data[0] & 0x0FU) << 8U) | (data[1] & 0xFFU));

    return err;
}

icm20948_err_t icm20948_set_accel_smplrt_div_reg(icm20948_t const* icm20948,
...
icm20948_err_t icm20948_get_accel_intel_ctrl_reg(icm20948_t const* icm20948,
...
icm20948_err_t icm20948_set_accel_intel_ctrl_reg(icm20948_t const* icm20948,
...
icm20948_err_t icm20948_get_accel_wom_thr_reg(icm20948_t const* icm20948,
...
icm20948_err_t icm20948_set_accel_wom_thr_reg(icm20948_t const* icm20948,
...
icm20948_err_t icm20948_get_accel_config_1_reg(icm20948_t const* icm20948,
...
icm20948_err_t icm20948_set_accel_config_1_reg(icm20948_t const* icm20948,
...
icm20948_err_t icm20948_get_accel_config_2_reg(icm20948_t const* icm20948,
...
icm20948_err_t icm20948_set_accel_config_2_reg(icm20948_t const* icm20948,
...
icm20948_err_t icm20948_set_fsync_config_reg(icm20948_t const* icm20948,
                                            ...
                                            icm20948_temp_config_reg_t* reg)
{
    ...
    icm20948_err_t err = icm20948_bank_read(icm20948,
                                            ICM20948_BANK_2,
                                            ICM20948_REG_ADDRESS_TEMP_CONFIG,
                                            &data,
                                            sizeof(data));
...
icm20948_err_t icm20948_set_temp_config_reg(icm20948_t const* icm20948,
...
icm20948_err_t icm20948_set_mod_ctrl_usr_reg(icm20948_t const* icm20948,
...
icm20948_err_t icm20948_get_i2c_mst_odr_config_reg(icm20948_t const* icm20948,
                                                   icm20948_i2c_mst_odr_config_reg_t* reg)
{
    ...
    icm20948_err_t err = icm20948_bank_read(icm20948,
                                            ICM20948_BANK_3,
                                            ICM20948_REG_ADDRESS_I2C_MST_ODR_CONFIG,
                                            &data,
                                            sizeof(data));
...
icm20948_err_t icm20948_set_i2c_mst_odr_config_reg(icm20948_t const* icm20948,
                                                   icm20948_i2c_mst_odr_config_reg_t const* reg)
{
    assert(icm20948 && reg);
...
icm20948_err_t icm20948_set_i2c_mst_ctrl_reg(icm20948_t const* icm20948,
...
icm20948_err_t icm20948_get_i2c_mst_delay_ctrl_reg(icm20948_t const* icm20948,
                                                   icm20948_i2c_mst_delay_ctrl_reg_t* reg)
{
    ...
    icm20948_err_t err = icm20948_bank_read(icm20948,
                                            ICM20948_BANK_3,
                                            ICM20948_REG_ADDRESS_I2C_MST_DELAY_CTRL,
                                            &data,
                                            sizeof(data));
...
icm20948_err_t icm20948_set_i2c_mst_delay_ctrl_reg(icm20948_t const* icm20948,
                                                   icm20948_i2c_mst_delay_ctrl_reg_t const* reg)
{
    assert(icm20948 && reg);
                                             ...
                                             icm20948_i2c_slv_addr_reg_t* reg)
{
    ...
    icm20948_err_t err =
        icm20948_bank_read(icm20948,
                           ICM20948_BANK_3,
                           ICM20948_REG_ADDRESS_I2C_SLV0_ADDR + (slave_num & 0x03U),
                           &data,
                           sizeof(data));
...
icm20948_err_t icm20948_set_i2c_slv_addr_reg(icm20948_t const* icm20948,
                                             icm20948_slave_num_t slave_num,
                                        ...
                                        icm20948_i2c_slv_reg_t* reg)
{
    ...
    icm20948_err_t err = icm20948_bank_read(icm20948,
                                            ICM20948_BANK_3,
                                            ICM20948_REG_ADDRESS_I2C_SLV0_REG + (slave_num & 0x03U),
                                            &data,
                                            sizeof(data));
                                             ...
                                             icm20948_i2c_slv_ctrl_reg_t* reg)
{
    ...
    icm20948_err_t err =
        icm20948_bank_read(icm20948,
                           ICM20948_BANK_3,
                           ICM20948_REG_ADDRESS_I2C_SLV0_CTRL + (slave_num & 0x03U),
                           &data,
                           sizeof(data));
...
icm20948_err_t icm20948_set_i2c_slv_ctrl_reg(icm20948_t const* icm20948,
                                             icm20948_slave_num_t slave_num,
...
icm20948_err_t icm20948_set_i2c_slv_do_reg(icm20948_t const* icm20948,
                                           icm20948_slave_num_t slave_num,
...
icm20948_err_t icm20948_get_i2c_slv4_addr_reg(icm20948_t const* icm20948,
...
icm20948_err_t icm20948_set_i2c_slv4_addr_reg(icm20948_t const* icm20948,
...
icm20948_err_t icm20948_get_i2c_slv4_reg(icm20948_t const* icm20948, icm20948_i2c_slv4_reg_t* reg)
{
    assert(icm20948 && reg);
...
icm20948_err_t icm20948_get_i2c_slv4_ctrl_reg(icm20948_t const* icm20948,
...
icm20948_err_t icm20948_set_i2c_slv4_ctrl_reg(icm20948_t const* icm20948,
                                            ...
                                            icm20948_i2c_slv4_do_reg_t* reg)
{
    ...
    icm20948_err_t err = icm20948_bank_read(icm20948,
                                            ICM20948_BANK_3,
                                            ICM20948_REG_ADDRESS_I2C_SLV4_DO,
                                            &data,
                                            sizeof(data));
...
icm20948_err_t icm20948_set_i2c_slv4_do_reg(icm20948_t const* icm20948,
                                            ...
                                            icm20948_i2c_slv4_di_reg_t* reg)
{
    ...
    icm20948_err_t err = icm20948_bank_read(icm20948,
                                            ICM20948_BANK_3,
                                            ICM20948_REG_ADDRESS_I2C_SLV4_DI,
                                            &data,
                                            sizeof(data));
